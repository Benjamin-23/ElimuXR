...
const Downloadcertyficate = props => {
  ...
  const DownloadCertificateStyles = useMemo(
    () => DownloadCertificateStyle(Colors),
    [Colors],
  );
  return (
    <Container>
            ...
            <View style={DownloadCertificateStyles.keybordtopviewstyle}>
              <View style={DownloadCertificateStyles.minflexview}>
                <View style={DownloadCertificateStyles.minviewsigninscreen}>
                  ...
                  <Text style={DownloadCertificateStyles.accounttext}>
                    {t('photography_Title_57')}
                  </Text>
                  <Text
                    style={DownloadCertificateStyles.accounttextsuccessfully}>
                    {t('photography_Titles_29')}
                  </Text>
                  <View style={DownloadCertificateStyles.accountbutton}>
                    <Button
                      title={t('photography_Titles_30')}
                      onPress={() =>

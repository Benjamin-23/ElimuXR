            ...
            <View style={SettingStyles.KeyBordTopViewStyle}>
              <View style={SettingStyles.MinFlexView}>
                <View style={SettingStyles.Togglrswitchflex}>
                  <View>
                    <Spacing space={SH(15)} />
                    <Text style={SettingStyles.CellularDataText}>
                      {t('Location_Track')}
                    </Text>
                  </View>
                </View>
                <View style={SettingStyles.TogglesWotchview}>
                  ...
                  <View style={SettingStyles.WidthSwitch}>
                    <Switch
                      trackColor={{
                        false: Colors.gray_text_color,
                        true: Colors.theme_background_brink_pink,
                      }}
                      thumbColor={
                        isEnabled
                ...
                <View style={SettingStyles.RightiConMinview}>
                  <View>
                    <Text style={SettingStyles.StandardRecommeDtext}>
                      {t('Location_Tracking')}
                    </Text>
                    <Text style={SettingStyles.DownloadFasterText}>
                      {t('Enables_Recommended')}
                    </Text>
                  </View>
                  <View>
                    <VectorIcons
                ...
                <Text style={LanguageStyle.Settingtext}>
                  {t('Select_Your_Language')}
                </Text>
                <TouchableOpacity
                  onPress={() => setModalVisible(true)}
                  style={LanguageStyle.SettingStyles}>
                ...
                <View style={SettingStyles.RightiConMinviewtwo}>
                  <View>
                    <Text style={SettingStyles.StandardRecommeDtext}>
                      {t('Standard_Qualitytext')}
                    </Text>
                    <Text style={SettingStyles.DownloadFasterText}>
                      {t('Downnloads_Qualitytext')}
                    </Text>
                  </View>
                </View>
              </View>

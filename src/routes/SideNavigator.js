...
const SideNavigator = props => {
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        name={RouteName.ONLINE_CLASS_SCREEN}
        component={OnlineClassScreen}
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Customesidebar_title_11')} />
          ),
          ...HeaderArray,
      ...
      <Drawer.Screen
        ...
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Customesidebar_title_12')} />
          ),
          ...HeaderArray,
          headerRight: () => (
            <ColorPickerandCheckoutIcon
      ...
      <Drawer.Screen
        ...
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Customesidebar_title_13')} />
          ),
          ...HeaderArray,
        }}
      />
      <Drawer.Screen
        name={RouteName.INSTRUCTOR_SCREEN}
        component={InstructorsScreen}
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Customesidebar_title_14')} />
          ),
          ...HeaderArray,
        }}
      />
      <Drawer.Screen
        name={RouteName.Purchased_History_Screen}
        component={PurchasedHistoryScreen}
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Customesidebar_title_15')} />
          ),
          ...HeaderArray,
          headerRight: () => <ColorPicker />,
        }}
      ...
      <Drawer.Screen
        ...
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Customesidebar_title_16')} />
          ),
          ...HeaderArray,
        }}
      />
      <Drawer.Screen
        ...
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Customesidebar_title_17')} />
          ),
          ...HeaderArray,
        }}
      />
      <Drawer.Screen
        ...
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Customesidebar_title_26')} />
          ),
          ...HeaderArray,
        }}
      />
